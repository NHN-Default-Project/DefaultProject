...
public class SimpleInterpreter {
    ...
    public static void main(String[] args) {
        ...
        // "pi"와 "e"라는 변수를 추가하여 프로그램 시작 시 표준 수학 상수를 나타내도록 합니다.
    ...
    private static double factorValue() throws ParseError {
        ...
        if (obj instanceof Double) {
            ...
            StandardFunction function = (StandardFunction) obj;
    ...
    private static Object primaryValue() throws ParseError {
        ...
        if (Character.isDigit(ch)) {
            ...
            if (obj instanceof Double) {
                ...
                StandardFunction function = (StandardFunction) obj;
                TextIO.getAnyChar(); //( 읽기
                double val = expressionValue(); //괄호안의 값 읽기
