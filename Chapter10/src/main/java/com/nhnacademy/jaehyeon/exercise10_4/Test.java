...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Exercise10_4.remove(before, isEvenNumber);
        ...
        Predicate<Integer> isPrime = obj -> {
            for (int i = 2; i < Math.sqrt(obj) / 2; i++) {
                if (obj % i == 0) {
                    return false;
                }
            }
        ...
        System.out.println("변경전");
        System.out.println(before.toString());
        Exercise10_4.retain(before, isPrime);
        System.out.println("변경후");
        System.out.println(before.toString());
        System.out.println("==================");
        ...
        System.out.println(Exercise10_4.collect(strings, isPhoneNumber).toString());
        System.out.println("==================");
        ...
        System.out.println(Exercise10_4.find(list, isYearNumber));
