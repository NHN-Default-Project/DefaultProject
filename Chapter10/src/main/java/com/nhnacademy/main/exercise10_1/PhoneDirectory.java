...
public class PhoneDirectory {
     ...
     */
    private void isCheckNameData(String inputData) throws DataEntryFormatException {
        Matcher matcher = namePattern.matcher(inputData);
    ...
    private void isCheckNumberData(String inputData) throws DataEntryFormatException {
        Matcher matcher = numberPattern.matcher(inputData);
    ...
    private boolean isDataEntryFormat(Matcher matcher) {
        return matcher.find();
    }

    private void isCheckEmpty(String data) throws EmptyDataException {
        if (data.isEmpty()) {
