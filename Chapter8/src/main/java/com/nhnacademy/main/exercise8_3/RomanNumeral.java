package com.nhnacademy.main.exercise8_3;
...
public class RomanNumeral {
    ...
    public RomanNumeral(String romanNumeral) {
        preconditionRomanNumeral(romanNumeral);
        preconditionDuplicateCount(romanNumeral);
    ...
    public int calculateArabicNum(int currentArabicNum, char currentChar, char nextChar) {
        if (RomanNumeralNotation.valueOf(String.valueOf(currentChar))
                .compareTo(RomanNumeralNotation.valueOf(String.valueOf(nextChar))) > 0) {
    ...
    public void convertArabicNumToEquivalentRomanNum(StringBuilder stringBuilder,
                                                        RomanNumeralNotation romanNumeralNotion, int romanValueIdx) {
        int loppCnt = 0;
