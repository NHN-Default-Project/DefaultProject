...
public class CreatingArrayListOfRandomNumsOfRange { // 7_1 예제
    ...
    public void makeArrayList(int intCount, int maxIntNum) {
        int randomNum;
