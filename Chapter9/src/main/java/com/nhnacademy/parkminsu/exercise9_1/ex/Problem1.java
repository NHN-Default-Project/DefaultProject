...
public class Problem1 {
    public static void main(String[] args) {
        try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            MathCalculator mathCalculator = formula::factorial;
            MathCalculator mathCalculator1 = formula::fibonacci;
            System.out.println(Calculator.calculate(mathCalculator, bigInteger));
